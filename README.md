# Project 2 - *NY Times Article Searcher*
...
* [x] SharedPreference to persist filter settings
* [x] Apply SwipeRefreshLayout for capability to refresh
* [x] Detect orientation and optimize display
* [x] CardView for elevation of each article item

## Video Walkthrough

Here's a walkthrough of implemented user stories:

[Video Walkthrough](https://imgur.com/a/ahGl3)
![Inline Video](nytsearch.gif)
...
* [Butterknife annotation library](http://guides.codepath.com/android/Reducing-View-Boilerplate-with-Butterknife)
* [Parceler library](http://guides.codepath.com/android/Using-Parceler).

## License

    Copyright [2016] [Tomo Otsuka]
